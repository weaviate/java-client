...
public class LiveChecker extends AsyncBaseClient<Boolean> implements AsyncClientResult<Boolean> {

  public LiveChecker(CloseableHttpAsyncClient client, Config config, AccessTokenProvider tokenProvider) {
