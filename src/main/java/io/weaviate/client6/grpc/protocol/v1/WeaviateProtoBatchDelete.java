...
public final class WeaviateProtoBatchDelete {
  ...
  public interface BatchDeleteReplyOrBuilder extends
     ...
     */
    java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObject> 
        getObjectsList();
    /**
     * <code>repeated .weaviate.v1.BatchDeleteObject objects = 5;</code>
     */
     ...
     * <code>repeated .weaviate.v1.BatchDeleteObject objects = 5;</code>
     */
    java.util.List<? extends io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObjectOrBuilder> 
  ...
  private static final long serialVersionUID = 0L;
    ...
    @SuppressWarnings("serial")
    private java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObject> objects_;
    /**
     * <code>repeated .weaviate.v1.BatchDeleteObject objects = 5;</code>
     */
    @java.lang.Override
    public java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObject> getObjectsList() {
      return objects_;
    }
    /**
     * <code>repeated .weaviate.v1.BatchDeleteObject objects = 5;</code>
     */
    @java.lang.Override
    public java.util.List<? extends io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObjectOrBuilder> 
        getObjectsOrBuilderList() {
      return objects_;
    }
    /**
    ...
    public static final class Builder extends
      ...
      private void ensureObjectsIsMutable() {
        if (!((bitField0_ & 0x00000010) != 0)) {
          objects_ = new java.util.ArrayList<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObject>(objects_);
          bitField0_ |= 0x00000010;
         }
      }
      ...
      public Builder addAllObjects(
          java.lang.Iterable<? extends io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObject> values) {
        if (objectsBuilder_ == null) {
          ensureObjectsIsMutable();
       ...
       * <code>repeated .weaviate.v1.BatchDeleteObject objects = 5;</code>
       */
      public java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoBatchDelete.BatchDeleteObject.Builder> 
