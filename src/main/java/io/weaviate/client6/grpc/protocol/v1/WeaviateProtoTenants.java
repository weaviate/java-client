...
public final class WeaviateProtoTenants {
  ...
  public interface TenantsGetReplyOrBuilder extends
     ...
     */
    java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.Tenant> 
        getTenantsList();
    /**
     * <code>repeated .weaviate.v1.Tenant tenants = 2;</code>
     */
     ...
     * <code>repeated .weaviate.v1.Tenant tenants = 2;</code>
     */
    java.util.List<? extends io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.TenantOrBuilder> 
  ...
  private static final long serialVersionUID = 0L;
    ...
    @SuppressWarnings("serial")
    private java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.Tenant> tenants_;
    /**
     * <code>repeated .weaviate.v1.Tenant tenants = 2;</code>
     */
    @java.lang.Override
    public java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.Tenant> getTenantsList() {
      return tenants_;
    }
    /**
     * <code>repeated .weaviate.v1.Tenant tenants = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.TenantOrBuilder> 
        getTenantsOrBuilderList() {
      return tenants_;
    }
    /**
    ...
    public static final class Builder extends
      ...
      private void ensureTenantsIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          tenants_ = new java.util.ArrayList<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.Tenant>(tenants_);
      ...
      public Builder addAllTenants(
          java.lang.Iterable<? extends io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.Tenant> values) {
        if (tenantsBuilder_ == null) {
          ensureTenantsIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, tenants_);
       ...
       * <code>repeated .weaviate.v1.Tenant tenants = 2;</code>
       */
      public java.util.List<io.weaviate.client6.grpc.protocol.v1.WeaviateProtoTenants.Tenant.Builder> 
