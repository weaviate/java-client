...
public record Text2VecNvidiaVectorizer(
  ...
  public VectorConfig.Kind _kind() {
    return VectorConfig.Kind.TEXT2VEC_NVIDIA;
  }
  ...
  public static Text2VecNvidiaVectorizer of() {
    return of(ObjectBuilder.identity());
  }

  public static Text2VecNvidiaVectorizer of(
      Function<Builder, ObjectBuilder<Text2VecNvidiaVectorizer>> fn) {
   ...
   */
  public Text2VecNvidiaVectorizer(
      String baseUrl,
      String model,
      Boolean truncate,
  ...
  public Text2VecNvidiaVectorizer(Builder builder) {
    this(
        builder.baseUrl,
        builder.model,
        builder.truncate,
  ...
  public static class Builder implements ObjectBuilder<Text2VecNvidiaVectorizer> {
    ...
    public Text2VecNvidiaVectorizer build() {
      return new Text2VecNvidiaVectorizer(this);
    }
  }
}
