...
public class WeaviateQueryClient<PropertiesT>
    extends
    AbstractQueryClient<PropertiesT, Optional<XWriteWeaviateObject<PropertiesT>>, QueryResponse<PropertiesT>, QueryResponseGrouped<PropertiesT>> {
  ...
  @Override
  protected Optional<XWriteWeaviateObject<PropertiesT>> fetchObjectById(FetchObjectById byId) {
