...
public record Multi2VecTwelveLabsVectorizer(
  ...
  public VectorConfig.Kind _kind() {
    return VectorConfig.Kind.MULTI2VEC_TWELVELABS;
  }
  ...
  public static final String MARENGO30 = "marengo3.0";

  public static Multi2VecTwelveLabsVectorizer of() {
    return of(ObjectBuilder.identity());
  }

  public static Multi2VecTwelveLabsVectorizer of(Function<Builder, ObjectBuilder<Multi2VecTwelveLabsVectorizer>> fn) {
    return fn.apply(new Builder()).build();
  }

  public Multi2VecTwelveLabsVectorizer(
      String baseUrl,
      String model,
  ...
  public Multi2VecTwelveLabsVectorizer(Builder builder) {
    this(
        builder.baseUrl,
        builder.model,
        builder.imageFields,
  ...
  public static class Builder implements ObjectBuilder<Multi2VecTwelveLabsVectorizer> {
    ...
    @Override
    public Multi2VecTwelveLabsVectorizer build() {
      return new Multi2VecTwelveLabsVectorizer(this);
    }
  }
}
