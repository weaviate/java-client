...
public record GenerativeSearch(Single single, Grouped grouped) {
  public static GenerativeSearch of(Function<Builder, ObjectBuilder<GenerativeSearch>> fn) {
    return fn.apply(new Builder()).build();
  }

  public GenerativeSearch(Builder builder) {
    this(builder.single, builder.grouped);
  }

  public static class Builder implements ObjectBuilder<GenerativeSearch> {
    ...
    @Override
    public GenerativeSearch build() {
      return new GenerativeSearch(this);
    }
  }
