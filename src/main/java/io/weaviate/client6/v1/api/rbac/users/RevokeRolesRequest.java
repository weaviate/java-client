...
public record RevokeRolesRequest(String userId, UserType userType, List<String> roleNames) {

  public static final Endpoint<RevokeRolesRequest, Void> _ENDPOINT = SimpleEndpoint.sideEffect(
      __ -> "POST",
      request -> "/authz/users/" + UrlEncoder.encodeValue(request.userId) + "/revoke",
