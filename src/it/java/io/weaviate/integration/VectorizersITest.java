...
public class VectorizersITest extends ConcurrentTest {
  ...
  public static final TestRule __ = compose.asTestRule();
  ...
  public void testVectorizerModel2VecPropeties() throws IOException {
    ...
    WeaviateObject<Map<String, Object>> obj1 = WeaviateObject
        .of(o -> o.properties(Map.of("name", "Dune", "author", "Frank Herbert")).uuid(uuid1));
    String uuid2 = "00000000-0000-0000-0000-000000000002";
    WeaviateObject<Map<String, Object>> obj2 = WeaviateObject
        .of(o -> o.properties(Map.of("name", "same content", "author", "same content")).uuid(uuid2));
