 ...
 *
 * <p>This test would have caught the snake_case {@code @SerializedName}
 * regression in {@link TextAnalyzer} that was silently dropping every
 * analyzer setting on the wire. Two layers of assertion:
 *
 * <ol>
 *   <li><b>Schema round-trip</b>: read the collection back via {@code
 ...
 *   <li><b>Behavioral</b>: insert a string and run a filter query that
