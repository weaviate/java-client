...
public class BackupTestSuite {
  ...
  public static void testFailOnCreateBackupStatusOnNotExistingBackend(Supplier<Result<BackupCreateStatusResponse>> supplierCreateStatus) {
    Result<BackupCreateStatusResponse> createStatusResult = supplierCreateStatus.get();
  ...
  public static void testFailOnRestoreBackupFromNotExistingBackend(Supplier<Result<BackupRestoreResponse>> supplierRestore) {
    Result<BackupRestoreResponse> restoreResult = supplierRestore.get();
  ...
  public static void testFailOnCreateStatusOfNotExistingBackup(Supplier<Result<BackupCreateStatusResponse>> supplierCreateStatus,
                                                               String backupId) {
    Result<BackupCreateStatusResponse> createStatusResult = supplierCreateStatus.get();
  ...
  public static void testFailOnRestoreBackupStatusOfNotStartedRestore(Supplier<Result<BackupCreateResponse>> supplierCreate,
                                                                      Supplier<Result<BackupRestoreStatusResponse>> supplierRestoreStatus,
                                                                      String backupId) {
    Result<BackupCreateResponse> createResult = supplierCreate.get();
  ...
  public static void testFailOnCreateBackupForBothIncludeAndExcludeClasses(Supplier<Result<BackupCreateResponse>> supplierCreate) {
    Result<BackupCreateResponse> createResult = supplierCreate.get();
  ...
  public static void testFailOnRestoreBackupForBothIncludeAndExcludeClasses(Supplier<Result<BackupCreateResponse>> supplierCreate,
                                                                            Supplier<Result<BackupRestoreResponse>> supplierRestore,
                                                                            Supplier<Result<Boolean>> supplierDeleteClass) {
    // Create backup
    Result<BackupCreateResponse> createResult = supplierCreate.get();
  ...
  public static void testCreateAndRestoreBackupWithWaitingWithConfig(Supplier<Result<BackupCreateResponse>> supplierCreateInvConfig,
  ...
  private static void assertThatAllPizzasExist(Function<String, Result<GraphQLResponse>> supplierGQLOfClass) {
    assertThatAllFoodObjectsExist(supplierGQLOfClass, "Pizza", "Quattro Formaggi", "Frutti di Mare", "Hawaii", "Doener");
  }
   ...
   * <br>Timeout: 5s
   */
  private static void waitForCreateStatus(Supplier<Result<BackupCreateStatusResponse>> supplierCreateStatus, String want) {
