...
public class ClientBatchCreateMockServer2Test {
  ...
  @Test
  @DataMethod(source = ClientBatchCreateMockServer2Test.class, method = "provideForNotCreateBatchDueToConnectionIssue")
  public void shouldNotCreateBatchDueToConnectionIssue(ObjectsBatcher.BatchRetriesConfig batchRetriesConfig,
    ...
    Supplier<Result<ObjectGetResponse[]>> supplierObjectsBatcher = () -> client.batch().objectsBatcher(batchRetriesConfig)
  ...
  @Test
  @DataMethod(source = ClientBatchCreateMockServer2Test.class, method = "provideForNotCreateBatchDueToTimeoutIssue")
  public void shouldNotCreateBatchDueToTimeoutIssue(ObjectsBatcher.BatchRetriesConfig batchRetriesConfig,
    ...
    BatchObjectsMockServerTestSuite.testNotCreateBatchDueToTimeoutIssue(supplierObjectsBatcher,
      ...
      assertGetSoup1CallsCount, assertGetSoup2CallsCount, expectedBatchCallsCount, "Read timed out");
  }
